...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h3 class="card-title"><i class="fas fa-chart-line mr-2"></i>Profit Report</h3>
    </div>
    <div class="card-body">
        <form action="<?= base_url('admin/reports/profit/generate') ?>" method="post" id="profit-report-form">
            <?= csrf_field() ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('profit-report-form').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            if (endDate - startDate > oneYear) {
                ...
                Swal.fire({
                    ...
                    text: 'Please wait while we generate your profit report...',
