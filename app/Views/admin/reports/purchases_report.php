...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h3 class="card-title"><i class="fas fa-shopping-cart mr-2"></i>Purchase Transaction Report</h3>
    </div>
    <div class="card-body">
        <form action="<?= base_url('admin/reports/purchases/generate') ?>" method="post" id="purchase-report-form">
            <?= csrf_field() ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('purchase-report-form').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            if (endDate - startDate > oneYear) {
                ...
                Swal.fire({
                    ...
                    text: 'Please wait while we generate your purchase report...',
